...
(function() {
  ...
  var ArgumentParser, BV_VERSION, OLD_VERSION, VERSION, VERSION_PATH, args, error, exception, execSync, fs, i, loadJSON, package_json, package_json_path, parser, path, ret, semver,
  ...
  parser.addArgument(['-s'], {
    action: 'storeTrue',
    defaultValue: false,
    help: 'Semantic version conversion.'
  });
